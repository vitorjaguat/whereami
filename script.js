...
// const [coords1, coords2, coords3] = [[52.508, 13.381], [19.037, 72.873], [-33.933, 18.474]]

// const whereAmI = function (coords) {
//     const [lat, lgn] = coords;
...
//Using getCurrentPosition and displaying neighbour countries:
const [coords1, coords2, coords3] = [[52.508, 13.381], [19.037, 72.873], [-33.933, 18.474]]
...
btn.addEventListener('click', function () {
    navigator.geolocation.getCurrentPosition(pos => {
        ...
        whereAmI([lat, lgn])
        console.log(lat, lgn);
        countriesContainer.insertAdjacentHTML('afterbegin', '<div class="country extra"><p>🪐</p> <p></p><p>You are here and your neighbours are:</p><div>');
        btn.remove();
